...
int digits(mpz_class n) {
  return n == 0 ? 1 :mpz_sizeinbase(n.get_mpz_t(), 10);
}
...
bool is_prime_mr(long long n) {
    ...
    const std::vector<long long> bases = [&]() {
        if (n < 2LL) return std::vector<long long>{};
        else if (n < 2047LL) return std::vector<long long>{2};
        else if (n < 1373653LL) return std::vector<long long>{2, 3};
        else if (n < 9080191LL) return std::vector<long long>{31, 73};
        else if (n < 25326001LL) return std::vector<long long>{2, 3, 5};
        else if (n < 3215031751LL) return std::vector<long long>{2, 3, 5, 7};
        else if (n < 4759123141LL) return std::vector<long long>{2, 7, 61};
        else if (n < 1122004669633LL) return std::vector<long long>{2, 13, 23, 1662803};
        else if (n < 2152302898747LL) return std::vector<long long>{2, 3, 5, 7, 11};
        else if (n < 3474749660383LL) return std::vector<long long>{2, 3, 5, 7, 11, 13};
        else if (n < 341550071728321LL) return std::vector<long long>{2, 3, 5, 7, 11, 13, 17};
        else if (n < 3825123056546413051LL) return std::vector<long long>{2, 3, 5, 7, 11, 13, 17, 19, 23};
